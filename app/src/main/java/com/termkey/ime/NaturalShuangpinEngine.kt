...
class NaturalShuangpinEngine(
    ...
    companion object {
        ...
        private val phraseCandidates = mapOf(
            ...
            "duo'shao" to listOf("多少"),
            "dui'bu'qi" to listOf("对不起"),
            "mei'guan'xi" to listOf("没关系"),
            "zai'jian" to listOf("再见"),
            "peng'you" to listOf("朋友"),
            "xue'xi" to listOf("学习"),
            "da'zi" to listOf("打字"),
            ...
            "dao'le" to listOf("到了"),
            "dao'di" to listOf("到底"),
            "yi'jing" to listOf("已经"),
            "zhi'dao" to listOf("知道"),
            "dao'li" to listOf("道理"),
            "zhe'li" to listOf("这里"),
            "na'li" to listOf("那里"),
            "zen'me" to listOf("怎么"),
            "dao'na" to listOf("到那"),
            "zhi'qian" to listOf("之前"),
            "zhi'hou" to listOf("之后"),
            "da'gai" to listOf("大概"),
            "xi'wang" to listOf("希望"),
            "jue'de" to listOf("觉得"),
            "ying'gai" to listOf("应该"),
            "zhi'yao" to listOf("只要"),
            "yin'ci" to listOf("因此"),
            "sui'ran" to listOf("虽然"),
            "ke'shi" to listOf("可是"),
            "er'qie" to listOf("而且"),
            "dan'yuan" to listOf("但愿"),
            "bu'guo" to listOf("不过"),
            "te'bie" to listOf("特别"),
            "kuang'qie" to listOf("况且"),
            "yu'lai'yu" to listOf("越来越"),
            "yue'lai'yue" to listOf("越来越"),
            "jiu'shi" to listOf("就是"),
            "zhi'lei" to listOf("之类"),
            ...
            "you'dian" to listOf("有点", "邮电"),
            "fei'chang" to listOf("非常"),
            "zong'suan" to listOf("总算"),
            "guan'yu" to listOf("关于"),
            "yu'qi" to listOf("与其"),
            "zhong'yu" to listOf("终于"),
            "shou'dao" to listOf("收到"),
            "kai'shi" to listOf("开始"),
            "jie'shu" to listOf("结束"),
            "huan'ying" to listOf("欢迎"),
            "duo'xie" to listOf("多谢"),
        )
